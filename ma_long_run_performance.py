...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .files a { display: inline-flex; align-items: center; gap: 8px; text-decoration: none; font: 600 13px/1 var(--sans); padding: 10px 14px; border: 1px solid var(--rule-strong); background: var(--panel); color: var(--text); border-radius: 6px; }
  .files a:hover { border-color: var(--text); }
  .files a.gh { background: var(--text); color: var(--ground); border-color: var(--text); }
  .files a:focus-visible { outline: 2px solid var(--text); outline-offset: 2px; }
...
<div class="wrap">
  <header class="masthead">
    <div>
      <div class="eyebrow">M&amp;A research &middot; April 2025</div>
      ...
      <nav class="files" aria-label="Project files">
        <a href="MA_Long_Run_Performance.xlsx"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2.5" y="1.5" width="11" height="13" rx="1.5"/><path d="M5 5.5h6M5 8h6M5 10.5h4"/></svg>Excel model</a>
        <a href="MA_Long_Run_Performance_Paper.pdf"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M4 1.5h5.5L12.5 4.5v10h-8.5z"/><path d="M9.5 1.5v3h3"/></svg>Paper</a>
        <a href="MA_Long_Run_Performance_Memo.pdf"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M4 1.5h5.5L12.5 4.5v10h-8.5z"/><path d="M9.5 1.5v3h3"/></svg>Memo</a>
        <a href="MA_Long_Run_Performance_Deck.pdf"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="1.5" y="2.5" width="13" height="9" rx="1"/><path d="M8 11.5v3M5.5 14.5h5"/></svg>Deck</a>
        <a href="https://github.com/AlessandroRadice/Mergers-and-acquisitions-long-run-performance/blob/main/MA_Long_Run_Performance.ipynb"><svg viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M5.5 4.5L2 8l3.5 3.5M10.5 4.5L14 8l-3.5 3.5"/></svg>Notebook</a>
        <a class="gh" href="https://github.com/AlessandroRadice/Mergers-and-acquisitions-long-run-performance"><svg viewBox="0 0 16 16" fill="currentColor"><path fill-rule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0016 8c0-4.42-3.58-8-8-8z"/></svg>Repository</a>
      </nav>
    </div>
    <div class="brief">
  ...
  <footer><span>Alessandro Radice &middot; educational project, not investment advice</span><span>Data to 31 March 2025</span></footer>
</div>
